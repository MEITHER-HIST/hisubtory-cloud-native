...
def main_api_view(request):
    ...
    station_list = [{"id": i+1, "station_id": i+1, "name": name, "station_name": name, "has_story": True, "clickable": True, "is_viewed": False} for i, name in enumerate(stations)]
...
# --- 2. Stories 전용 뷰 (ImportError 해결용) ---
...
class EpisodeDetailAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        return Response({
            "success": True,
            "episode": {"episode_id": 1, "subtitle": "신비한 이야기"},
            "cuts": [{"cut_id": 1, "image": "https://picsum.photos/800/1200", "caption": "지하철의 비밀..."}]
        })
